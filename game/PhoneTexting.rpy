...
define MC_Name = "shin" ##The name of the main character, used to place them on the screen
define keng = "Kenglnwza007"
define nut = "Kurumi<3"
        ...
        if d.who == None: # Narrator
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "shin.png"
                    elif d.who == keng:
                        $ message_icon = "keng.png"
                    elif d.who == nut:
                        $ message_icon = "nut.png"
                    else:
